...
(function (astrology) {
  ...
  astrology.SYMBOL_AXIS_FONT_COLOR = '#000';
  ...
  astrology.CUSPS_FONT_COLOR = '#FFF';
  ...
  astrology.COLOR_ARIES = '#000';
  astrology.COLOR_TAURUS = '#000';
  astrology.COLOR_GEMINI = '#000';
  astrology.COLOR_CANCER = '#000';
  astrology.COLOR_LEO = '#000';
  astrology.COLOR_VIRGO = '#000';
  astrology.COLOR_LIBRA = '#000';
  astrology.COLOR_SCORPIO = '#000';
  astrology.COLOR_SAGITTARIUS = '#000';
  astrology.COLOR_CAPRICORN = '#000';
  astrology.COLOR_AQUARIUS = '#000';
  astrology.COLOR_PISCES = '#000';
  ...
  astrology.ASPECTS = {
    ...
    square: { degree: 90, orbit: 8, color: '#000' },
    trine: { degree: 120, orbit: 8, color: '#FFF' },
    opposition: { degree: 180, orbit: 10, color: '#FFF' },
  };
...
(function (astrology) {
  ...
  astrology.SVG.prototype._getSymbol = function (name, x, y) {
    switch (name) {
      ...
      default:
        ...
        unknownPoint.setAttribute('stroke', '#000');
        unknownPoint.setAttribute('stroke-width', 1);
        unknownPoint.setAttribute('fill', '#000');
        return unknownPoint;
    }
  };
  ...
  astrology.SVG.prototype.getSymbol = function (name, x, y) {
    if (astrology.CUSTOM_SYMBOL_FN == null)
